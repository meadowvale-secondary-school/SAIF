...
print("The variable foo is only declared locally in the for-loop")
/*:
...
print("The variable x was defined in a global scope and modified in a local scope, foo was a local scope variable being used in a global scope print statement")
/*:
