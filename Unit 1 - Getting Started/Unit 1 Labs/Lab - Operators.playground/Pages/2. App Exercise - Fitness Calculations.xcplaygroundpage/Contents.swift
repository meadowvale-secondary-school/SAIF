...
let avgHR = addedHR/3
print("Average Heart Rate is:", avgHR)
/*:
...
print(avgHRD)
print("The answer has a decimal point because the avg heart rate was a double")
/*:
...
print("You have achived:",percentOfGoal,"% of goal")
