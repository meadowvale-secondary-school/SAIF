...
var favBook = Book(title: "The Book Theif", price: 11.97, pages: 586, author: "Markus Zusak")
print("My favorite book has \(favBook.pages) pages and costs \(favBook.price) dollers, is written by \(favBook.author) and is called \(favBook.title)")
/*:
 ...
 */
var myheight = Height.init(centimeters: 179)
