...
struct RunningWorkout {
    ...
    var avgerageMileTime: Double {
        return time/distance * 1600}
}
var run = RunningWorkout(distance: 9_000, time: 2500, elevation: 15)
print(run.avgerageMileTime)
/*:
...
struct Steps {
    var steps: Int{
        willSet {
            if newValue == goal{
                print ("Congratulations you have achived your goal")}
            }
    }
    var goal: Int
...
var takeStep = Steps(steps: 9999, goal: 10_000)
