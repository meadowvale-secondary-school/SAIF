...
var test = Rectangle.init(width: 2, height: 4)
print(test.area)
/*:
...
struct Height {
    var heightInInches: Double {
        didSet {
            let newCm = heightInInches*2.54
            if heightInCentimeters != newCm {
                heightInCentimeters = newCm
            }
        }
    }
...
var testHeight = Height(heightInCentimeters: 5)
print(testHeight.heightInInches)
