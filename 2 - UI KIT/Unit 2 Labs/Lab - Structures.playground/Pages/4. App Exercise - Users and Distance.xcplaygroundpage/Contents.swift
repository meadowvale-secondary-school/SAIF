 ...
 */
var saif = User(age: 16, name: "Saif", height: 179, weight: 180, activityLevel: 7)
print("The user's name is \(saif.name). He is \(saif.age) years old and is \(saif.height) cm tall and weights \(saif.weight) lbs. His activity level is \(saif.activityLevel).")
 ...
 */
var test = Distance.init(meters: 1)
print(test.feet)
